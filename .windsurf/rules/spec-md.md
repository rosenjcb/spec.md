...
> This guide teaches Windsurf to author and maintain `*.spec.md` files — the [spec.md](https://github.com/rosenjcb/spec.md) format. It is generated from the canonical [`SKILL.md`](../SKILL.md); see there and [`TESTING.md`](../TESTING.md) for the source of truth.
